...
echo   %b%"----------------------------------------------------------------------------"%w%
echo.
echo              %RED%===-{ AVISO IMPORTANTE ANTES DE CONTINUAR } -===
echo.  
...
echo.  
echo. %o%[ 1 ]%gg% CRIAR UM PONTO DE RESTAURACAO%b%  -  %o%[ 2 ]%gg% ABRIR RESTAURACAO DO SISTEMA
echo.
echo                             %o%[ 3 ]%gg% IGNORAR E CONTINUAR???
echo.
echo.
echo   %b%"----------------------------------------------------------------------------"%w%
echo   %b%"----------------------------------------------------------------------------"%w%
...
echo    %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo 	   %o%[ 1 ]%gg% Limpeza Basica e Avancada   -   %g%[ 2 ] +Ferramentas do TI%gg%
echo.
echo.
echo 	   %o%[ 3 ]%gg% Links Importantes
echo.
echo.
echo                              %w%[ 0 ]%gg% Sair?
echo.
echo    %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p "op=. Digite sua escolha:%bb% "
if "%op%"=="1" goto limpbav
if "%op%"=="2" goto menu2
if "%op%"=="3" goto linksimptts
if "%op%"=="0" goto sair
goto teclaerrada
...
:: =============================================================================
:: LIMPEZA AVANCADA E BASICA WINDOWS
:: =============================================================================
:limpbav
cls
echo.
...
echo.
echo.
echo       %o%[ 1 ]%gg% Services.W    %o%[ 2 ]%gg% Limpar Navegadores    %o%[ 3 ]%gg% +Debloaters
echo.
echo       %o%[ 4 ]%gg% Avancados demais  -   %o%[ 5 ]%gg% OtmiGusst  -  %o%[ 6 ]%gg% Prioridade em Games
echo.
echo       %o%[ 7 ]%gg% Perifericos   -   %w%[ 0 ]%gg% Menu Anterior
echo. 
echo.
echo    %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p "op=. Digite sua escolha:%bb%"
...
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
set /p "choice=. Digite sua escolha:%bb% "
...
echo.
echo.
echo                 %o%[1]%gg% do Google Chrome%w%
echo.
echo 		%o%[2]%gg% do Microsoft Edge%w%
echo.
echo 		%o%[3]%gg% do Mozilla Firefox%w%
echo.
echo 		%o%[4]%gg% do Brave%w%
echo.
echo 		%o%[5]%gg% de TODOS navegadores%w%
echo.
echo 		%o%[6]%g% Debloater Apps Windows++%gg%
echo.
echo.
echo 		%w%[0] Menu anterior%gg%
echo.
...
echo.
echo.
echo 		%o%[1]%gg% Remover Apps inuteis%w%
echo.
echo 		%o%[2]%gg% Remover Xbox%w%
echo.
echo 		%o%[3]%gg% Remover Fotos%w%
echo.
echo 		%o%[4]%gg% Remover Store Windows%w%
echo.
echo.
echo 		%w%[0] Menu anterior%gg%
echo.
...
echo.
echo.
echo 		%o%[1]%gg% Limpar cache do Google Chrome%w%
echo.
echo 		%o%[2]%gg% Limpar cache do Microsoft Edge%w%
echo.
echo 		%o%[3]%gg% Limpar cache do Mozilla Firefox%w%
echo.
echo 		%o%[4]%gg% Limpar cache do Opera%w%
echo.
echo 		%o%[5]%gg% Limpar cache do Brave%w%
echo.
echo 		%o%[6]%gg% Limpar TODOS os caches%w%
echo.
echo.
echo 		%w%[0] Menu Principal%gg%
echo.
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------
set /p "escolha=. Escolha uma opcao:%bb% "
...
echo.
echo.
echo 	%o%[1]%gg% Desativar Hibernacao%w%                          %o%[11]%gg% Recuperar Senhas Wifi%w%
echo.
echo 	%o%[2]%gg% BIOS pelo CMD%w%                                 %o%[12]%gg% Gerenciamente avancado Usuarios%w%
echo.
echo 	%o%[3]%gg% Infos. completas Sistema e Hardware%w%
echo.
echo 	%o%[4]%gg% Forcar Reiniciar o PC%w%
echo.
echo 	%o%[5]%gg% Reiniciar PC em Modo Seguro (Kuidado aki)%w%
echo.
echo 	%o%[6]%gg% Sair do Modo Seguro (Korrige o acima)%w%
echo.
echo 	%o%[7]%gg% Restauracao do Sistema (reinicie pressionando SHIFT)%w%
echo.
echo 	%o%[8]%gg% %g%+ Planos de Energia%gg%
echo.
echo 	%o%[9]%gg% Remover Pontos de Restauracao%w%
echo.
echo 	%o%[10]%gg% Remover o Edge Completamente do Sistema%w%
echo.
echo.
echo.
echo 		%w%[0] Menu anterior%gg%
...
if "%escolha%"=="11" goto menuwifi
if "%escolha%"=="12" goto menugeusuavan
...
echo.
echo.
echo 		%o%[1]%gg% Ativar o Plano Ultra Performance%w%
echo.
echo 		%o%[2]%gg% Ativar Modo Desempenho Maximo%w%
echo.
echo 		%o%[3]%gg% Economia de Energia (NoteBooks)%w%
echo.
echo 		%r%[8]%gg% Remover Planos, exceto o atual (O abaixo e melhor)%w%
echo.
echo 		%r%[9]%gg% Restaurar Planos Padrao do Windows (Recomendado)%w%
...
echo %w%Plano de energia ativo (nao ser  deletado):%r% !activeScheme!
...
echo   %BLUE%====================================================================================================%RESET%
echo.
echo            %y%LINKS PARA AS MELHORES FERRAMENTAS DE OTIMIZCAO DO WINDS%w%
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo 		%o%[1]%gg% BoosterX - Excelente%w%            %o%[15]%gg% WinTools Premium- LimpezaTop%w%
echo.
echo 		%o%[2]%gg% SparKle%w%                         %o%[16]%gg% Glary Utilities Pro- Top%w%
echo.
echo 		%o%[3]%gg% ChrisTitus Tweaks%w%               %o%[17]%gg% Complete Internet Repair%w%
echo.
echo 		%o%[4]%gg% Optimizer%w%                       %o%[18]%gg% RevoUninstaller Pro%w%
echo.
echo 		%o%[5]%gg% WinSysClean%w%                     %o%[19]%gg% Revo Registry Cleaner%w%
echo.
echo 		%o%[6]%gg% TweakPower%w%                      %o%[20]%gg% JWizard Cleaner -Limpeza%w%
echo.
echo 		%o%[7]%gg% Firemin, Edgemin e Cromin%w%       %o%[21]%gg% RyTuneX - Optmizer%w%
echo.
echo 		%o%[8]%gg% MemReduct                       %o%[%g%22%o%]%gg% QuickCPU%w%
echo.
echo 		%o%[9]%gg% PyDebloatX%w%                      %o%[%g%23%o%]%gg% UnparkCPU%w%
echo.
echo 		%o%[10]%gg% Dism++ - limpeza%w%
echo.
echo 		%o%[11]%gg% Privacy-Repairer%w%
echo.
echo 		%o%[12]%gg% QuickBoost%w%
echo.
echo 		%o%[13]%gg% WinaeroTweaker%w%
echo.
echo 		%o%[14]%gg% WinSecret-Plus%w%
echo.
echo.
echo 		%o%[90]%g% Ferramentas NoobLinuxNodes%w%
echo.
echo 		                    %w%[0]%gg%Menu principal
echo.
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------%gg%
set /p opcao=". Digite o numero:%bb% "

if %opcao% equ 0 goto linksimptts
if %opcao% equ 1 goto boosterx
if %opcao% equ 2 goto sparkle
if %opcao% equ 3 goto christitus
if %opcao% equ 4 goto optimizer
if %opcao% equ 5 goto winsysclean
if %opcao% equ 6 goto tweakower 
if %opcao% equ 7 goto firemin
if %opcao% equ 8 goto memreductt
if %opcao% equ 9 goto pydebloatx
if %opcao% equ 10 goto dissmm
if %opcao% equ 11 goto privacidaderep
if %opcao% equ 12 goto QuickBoost
if %opcao% equ 13 goto WinaeroTweaker
if %opcao% equ 14 goto winsecret-plus
if %opcao% equ 15 goto wintools-one-portable
if %opcao% equ 16 goto glary-utilities-portable
if %opcao% equ 17 goto complete-internet-repair
if %opcao% equ 18 goto revo-uninstaller-pro
if %opcao% equ 19 goto revo-registry-cleaner-portable
if %opcao% equ 20 goto jwizard-cleaner-portable
if %opcao% equ 21 goto RyTuneX
if %opcao% equ 22 goto quickcpu
if %opcao% equ 23 goto unparcpu

if %opcao% equ 90 goto nodesiste
echo.
echo    Opss!!! OPCAO ERRADA. ESCOLHA NOVAMENTE.
echo.
     pause
goto scriptsbons
...
:boosterx
cls
start https://boosterx.org/en/
timeout /t 3 >nul
goto scriptsbons

:sparkle
cls
start https://github.com/Parcoil/Sparkle/releases
timeout /t 3 >nul
goto scriptsbons
...
:optimizer
cls
start https://github.com/hellzerg/optimizer
timeout /t 3 >nul
goto scriptsbons

:winsysclean
cls
start https://www.usro.net/winsysclean/installed/
timeout /t 3 >nul
goto scriptsbons

:tweakower
cls
start https://kurtzimmermann.com/downtp_en.html
timeout /t 3 >nul
goto scriptsbons

:firemin
cls
start https://rizonesoft.com/downloads/firemin/
timeout /t 3 >nul
goto scriptsbons

:memreductt
cls
start https://github.com/henrypp/memreduct
timeout /t 3 >nul
goto scriptsbons

:PyDebloatX
cls
start https://github.com/Teraskull/PyDebloatX
timeout /t 3 >nul
goto scriptsbons

:dissmm
cls
start https://github.com/Chuyu-Team/Dism-Multi-language/releases
timeout /t 3 >nul
goto scriptsbons

:privacidaderep
cls
start https://www.securilla.com/privacy-repairer
timeout /t 3 >nul
goto scriptsbons

:QuickBoost
cls
start https://github.com/SanGraphic/QuickBoost/releases
timeout /t 3 >nul
goto scriptsbons

:WinaeroTweaker
cls
start https://winaerotweaker.com/
timeout /t 3 >nul
goto scriptsbons

:winsecret-plus
cls
start https://www.fcportables.com/winsecret-plus-portable/
timeout /t 3 >nul
goto scriptsbons

:wintools-one-portable
cls
start https://www.fcportables.com/wintools-one-portable/
timeout /t 3 >nul
goto scriptsbons

:glary-utilities-portable
cls
start https://www.fcportables.com/glary-utilities-portable/
timeout /t 3 >nul
goto scriptsbons

:complete-internet-repair
cls
start https://rizonesoft.com/downloads/complete-internet-repair/
timeout /t 3 >nul
goto scriptsbons

:revo-uninstaller-pro
cls
start https://www.fcportables.com/revo-uninstaller-pro-portable/
timeout /t 3 >nul
goto scriptsbons

:revo-registry-cleaner-portable
cls
start https://www.fcportables.com/revo-registry-cleaner-portable/
timeout /t 3 >nul
goto scriptsbons

:jwizard-cleaner-portable
cls
start https://www.fcportables.com/jwizard-cleaner-portable/
timeout /t 3 >nul
goto scriptsbons

:RyTuneX
cls
start https://github.com/rayenghanmi/?tab=readme-ov-file
timeout /t 3 >nul
goto scriptsbons
...
:unparcpu
cls
start https://coderbag.com/programming-c/disable-cpu-core-parking-utility
timeout /t 3 >nul
goto scriptsbons

:nodesiste
cls
start https://nooblinuxnodes.blogspot.com/2025/10/windows-ferramentas-essenciais.html
timeout /t 3 >nul
goto scriptsbons
...
echo.
echo        %o%[ %b%31 %o%]%w% Atualizar Drivers              %o%[ %b%32 %o%]%w% Limpar Arquivos Temporarios  
echo.
...
echo.
echo        %o%[ %b%37 %o%]%w% REINICIAR PC
echo.
echo                                 %o%[ 0 ] Menu Anterior%w%
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p opcao=". Digite o numero:%bb% "

if "%opcao%"=="000" goto otmiguss
...
echo.
echo.
echo    %o%[1]%gg% Iniciar Otimizacao (Remover Xbox)%w%
echo.
echo    %o%[2]%gg% Reverter Otimizacao (Restaurar Xbox)%w%
echo.
echo.
echo      %o%[0]%gg% Voltar ao Menu anterior%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p "escolha=. Digite a opcao desejada:%bb% "
...
echo.
echo.        
	echo             %y%Reiniciando agora...%w%
    shutdown /r /t 5
) else (
    echo       %y%Nao reiniciado. Voltando ao menu anterior.%w%
    pause
    goto otmiguss
)
pause
...
:opcao6
cls
echo %y%Desativando Relat rios de erro do windows...%w%
sc stop "WerSvc"
...
echo %g%Relat rios de Erros do Windows desativado com Sucesso!%w%
pause
goto otmiguss
...
echo.
echo.
echo    %o%1%gg% - Otimizar ALT + TAB%w%
echo.
echo    %o%2%gg% - Reverter ALT + TAB%w%
echo.
echo.
echo    %w%3%gg% - Voltar para o menu anterior%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p escolhaAltTab=. Digite a opcao desejada:%bb% 
...
:opcao8
cls
echo %y%Otimizando Rel gio do Windows...%w%
...
echo.
echo.
echo     %o%[1]%gg% Desativar Servicos%w%
echo.
echo     %o%[2]%gg% Reverter Otimizacao%w%
echo.
echo.
echo     %w%[0]%gg% Voltar ao Menu Principal%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p opcao=. Digite a opcao desejada:%bb% 
...
echo.
echo.
echo %o%[1]%gg% Aumentar prioridade do explorer.exe (apenas para pc que o windows trava, nao recomendo para quem joga)%w%
echo.
echo %o%[2]%gg% Reverter prioridade para o padrao%w%
echo.
echo.
echo %w%[0]%gg% Voltar%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p "scolha=. Digite sua opcao:%bb% "
cls
...
echo.
echo.
echo %o%[1]%gg% Remover apps padrao e Desativar Copilot, OfficeHub e outros recursos.%w%
echo.
echo %o%[2]%gg% Reinstalar apps padrao do Windows%w%
echo.
echo.
echo %w%[0]%gg% Voltar ao menu principal%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p opcao=. Escolha uma opcao:%bb% 
...
echo.
echo     %g%Reinstalacao concluida!%w%
pause
cls
goto opcao13
...
:opcao16
cls
echo %y%Bloqueando Envio de feedback Autom tico%w%
reg add "HKCU\Software\Microsoft\Siuf\Rules" /v NumberOfSIUFInPeriod /t REG_DWORD /d 0 /f
...
echo.
echo.
echo     %o%1%gg% - Desativar Overlays (Game Bar e Game Mode)%w%
echo.
echo     %o%2%gg% - Reverter Overlays ao Padrao%w%
echo.
echo.
echo     %w%0%gg% - Voltar ao Menu Principal%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p escolha_overlay=. Escolha uma opcao:%bb% 
...
echo.
echo.
echo    %o%[1]%gg% Otimizar rede para jogos (Low latency)%w%
echo.
echo    %o%[2]%gg% Reverter configuracoes de rede para o padrao%w%
echo.
echo.
echo    %w%[0]%gg% Voltar ao Menu Principal%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p escolha=. Digite sua opcao:%bb% 
...
taskkill /f /im explorer.exe
echo.
echo     AO CONTINUAR, O EXPLORER SERA REABERTO.
echo.
pause
start explorer.exe
echo.
echo       %g% Acao Concluid!%w%
pause
cls
goto otmiguss
...
echo.
echo.
echo        A PROXIMA ACAO IRA DESATIVAR O UAC.
echo        RECOMENDO QUE NAO FACA ISSO. 
echo        ELE TE ALERTA QUANDO UMA APLICACAO QUER SER EXECUTADA COMO ADMINISTRADOR.
echo        AO DESATIVAR, ISSO NAO MAIS VAI ACONTECER.
echo        SE ENTENDE MESMO OS RICOS, CONTINUE ABAIXO.
echo.
sfc /scannow
pause
echo.
...
start https://www.sordum.org/7952/dns-jumper-v2-3/
...
:opcao31
cls
echo %y%Baixe o DriverBooster...%w%
start https://www.fcportables.com/driver-booster-portable/
...
:opcao32
cls
echo %y%Limpando arquivos tempor rios do Windows...%w%
set "windows=%windir%"
set "systemdrive=%systemdrive%"
set "userprofile=%userprofile%"
set "temp=%temp%"
...
echo.
echo        %o%[ %o%0 %o%]%o% Menu Anterior%w%
echo.
echo                         %o%[ %o%000%o% ]%o% REVERTA AO PADRaO DO WINDOWS%w%    
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p jogo=". Digite o numero:%bb% "
cls
...
echo %BLUE%====================================================================================================%RESET%
echo.
echo    %y%OTIMIZAcaO DE PERIF RICOS%w%
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo.
...
start https://openhardwaremonitor.org/downloads/
pause
cls
goto perifericos
...
echo.
echo.
echo    %o%[1]%gg% Reverter Otimizacao do Mouse%w%
echo.
echo    %o%[2]%gg% Reverter Otimizacao do Teclado%w%
echo.
echo    %o%[3]%gg% Reverter Input Lag / Monitor%w%
echo.
echo    %o%[4]%gg% Reverter SSD%w%
echo.
echo    %o%[5]%gg% Reverter HDD%w%
echo.
echo    %o%[6]%gg% Reverter TODOS%w%
echo.
echo.
echo    %w%[0]%gg% Voltar%w%
echo.
...
echo   %BLUE%====================================================================================================%RESET%
echo.
echo               %y% LINKS PARA APPS ESSENCIAIS E POS-FORMATACAO%w%
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo.
echo 		%o%[1]%gg% Outros Scrips Bons
echo.
echo 		%o%[2]%gg% Apps Essenciais e Pos-Formatacao
echo.
echo.
echo.
...
if %opcao% equ 1 goto scriptsbons
if %opcao% equ 2 goto appsessns
   goto linksimptts
...
:: =============================================================================
:: APPS ESSENCIAIS E POS-FORMATACAO
:: =============================================================================
:appsessns
mode 105,45
cls
...
echo   %BLUE%====================================================================================================%RESET%
echo.
echo               %y%APPS ESSENCIAIS E POS-FORMATACAO%w%
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo.
echo 		%o%[1]%gg% Winrar-64bits (Link)%w%       %o%[13]%gg% Driver Booster%w%
echo.
echo 		%o%[2]%gg% Brave Browser%w%              %o%[14]%gg% Recuva%w%
echo.
echo 		%o%[3]%gg% Firefox Browser%w%            
echo.
echo 		%o%[4]%gg% Google Chrome (Link)%w%
echo.
echo 		%o%[5]%gg% KLCodec-Pack (Link)%w%
echo.
echo 		%o%[6]%gg% Gimp-Me (Link)%w%
echo.
echo 		%o%[7]%gg% MS-Office (Link)%w%
echo.
echo 		%o%[8]%gg% WUpdate Blocker%gg%
echo.
echo 		%o%[9]%gg% Edge Blocker%w%
echo.
echo 		%o%[10]%gg% Controle o Defender%w%
echo.
echo 		%o%[11]%gg% UniGet-UI%w%
echo.
echo 		%o%[12]%gg% Snapppy Driver Lite%w%
echo.
echo 		%o%[XX]%g% Ativar Windows/Office%w%        %o%[25]%g% Personalizacao
echo.
echo.
echo 		                     %w%[0] Menu principal
echo.
...
if %opcao% equ 0 goto linksimptts
if %opcao% equ 1 goto winrarrr
if %opcao% equ 2 goto bravebrowser
if %opcao% equ 3 goto firefoxbrowser
if %opcao% equ 4 goto googlechrome
if %opcao% equ 5 goto kcodec
if %opcao% equ 6 goto gimpapp
if %opcao% equ 7 goto msoffice
if %opcao% equ 8 goto wupdblocker
if %opcao% equ 9 goto edgeblocker
if %opcao% equ 10 goto defendercontrol
if %opcao% equ 11 goto UniGetUI
if %opcao% equ 12 goto SnapppyDriverLite
if %opcao% equ 13 goto driverbooster
if %opcao% equ 14 goto apprecuva
if %opcao% equ 25 goto personalizcoes

  if %opcao% equ ativador goto atvwoffc1
   if %opcao% equ XX goto atvwoffc2
    if %opcao% equ xx goto atvwoffc3
...
cls
echo.
start https://www.gimp.org/downloads/
timeout /t 3 >nul
goto appsessns
...
cls
echo.
start https://ankhtech.weebly.com/microsoftoffice.html
timeout /t 3 >nul
goto appsessns
...
cls
echo.
start https://www.sordum.org/?s=Windows+Update+Blocker
timeout /t 3 >nul
goto appsessns
...
cls
echo.
start https://www.sordum.org/?s=edge+blocker
timeout /t 3 >nul
goto appsessns
...
cls
echo.
start https://www.sordum.org/?s=defender+control
timeout /t 3 >nul
goto appsessns
...
:apprecuva
cls
start https://www.fcportables.com/recuva-portable/
timeout /t 3 >nul
goto appsessns
...
echo.
echo.
echo      Nao, a senha nao e XX. Tente de novo.
echo     Dica: tem a ver com dor em algum lugar.
echo      Kkkkkkkk, Kkkkkkkkk...
echo.
pause
goto appsessns
:atvwoffc3
...
echo.
echo.
echo      Nao, a senha tambem nae e xx. Tente mais uma vez, seu boco de NY.
echo     Repito a dica: tem a ver com dor em algum lugar.
echo      Kkkkkkkk, Kkkkkkkkk...
echo.
pause
goto appsessns
...
:: =============================================================================
::    APPS PARA PERSONALIZAR SEU WINDOWS
:: =============================================================================
:personalizcoes
mode 105,30
cls
...
echo   %BLUE%====================================================================================================%RESET%
echo.
echo               %y%APPS PARA PERSONALIZAR SEU WINDOWS%w%
echo.
echo   %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo.
echo 		%o%[1]%gg% WINDHAWK%w%                       %o%[3]%gg% WinaAroTweaker%w%
echo.
echo 		%o%[2]%gg% Open-Shell-Menu (Iniciar)%w%      %o%[4]%gg% Apps Classicos%w%
echo.
echo 		%o%[5]%gg% Barra de Tarefas menor%w%         %o%[6]%gg% RainMeter%w%
echo.
echo.
...
if %opcao% equ 0 goto appsessns
if %opcao% equ 1 goto windhawk
if %opcao% equ 2 goto Open-Shell-Menu
if %opcao% equ 3 goto winaerotweakertheme
if %opcao% equ 4 goto appsclassics
if %opcao% equ 5 goto btarefamenor
if %opcao% equ 6 goto rainmeter
pause
goto personalizcoes
...
cls
echo.
::001 - Link de como instalar corretamente.
start https://winaero.com/how-to-restore-classic-start-menu-in-windows-11-and-get-back-live-tiles/#How_to_change_the_Start_menu_icon_in_Open-Shell
::002 - Link da ferramenta.
start https://open-shell.github.io/Open-Shell-Menu/
timeout /t 3 >nul
goto personalizcoes
...
cls
echo.
start https://windhawk.net/mods/taskbar-icon-size
timeout /t 3 >nul
goto personalizcoes
