...
echo.
echo 	   %o%[ 3 ]%neon_vp% Outros Scrips Bons          -   %o%[ 4 ]%neon_vp% Apps Essenciais (Lins)
echo.
echo.
...
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo 		%o%[1]%neon_vp% BoosterX - Excelente (Link)%w%            %o%[15]%neon_vp% WinTools Premium- LimpezaTop%w%
echo.
echo 		%o%[2]%neon_vp% SparKle (Link)%w%                         %o%[16]%neon_vp% Glary Utilities Pro- Top%w%
echo.
echo 		%o%[3]%neon_vp% ChrisTitus Tweaks%w%
echo.
echo 		%o%[4]%neon_vp% Optimizer (Link)%w%
echo.
echo 		%o%[5]%neon_vp% WinSysClean (Link)%w%
echo.
echo 		%o%[6]%neon_vp% TweakPower (Link)%w%
echo.
echo 		%o%[7]%neon_vp% Firemin, Edgemin e Cromin (Link)%w%
echo.
echo 		%o%[8]%neon_vp% MemReduct (Link)%neon_vp%
echo.
echo 		%o%[9]%neon_vp% PyDebloatX (Link)%w%
echo.
echo 		%o%[10]%neon_vp% Dism++%w%
echo.
...
echo.
echo        %o%[ %b%31 %o%]%w% Atualizar Drivers              %o%[ %b%32 %o%]%w% Limpar Arquivos Tempor rios  
echo.
...
echo.
echo.
echo      %neon_vp% Voltar ao Menu Principal%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
set /p "scolha=Digite a opcao desejada: "
...
echo.
echo %g%Reinstalacao conclu da!%w%
pause
cls
goto opcao13
...
echo.
echo 		%o%[2]%neon_vp% Brave Browser%w%              %o%[13]%neon_vp% Recuva%w%
echo.
...
echo.
echo 		%o%[XX]%neon_vp% Ativar Windows/Office%w%
echo.
echo.
echo 		%w%[0]%neon_vp% Menu principal
echo.
