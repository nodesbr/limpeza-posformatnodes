...
echo.
echo.
echo 	   %o%[ 1 ]%neon_vp% Limpeza Basica e Avancada   -   %g%[ 2 ] +Ferramentas do TI%neon_vp%
echo.
echo 	   %o%[ 3 ]%neon_vp% Outros Scrips Bons          -   %o%[ 4 ]%neon_vp% Apps Essenciais
echo.
echo.
echo.
...
if "%op%"=="2" goto menu2
if "%op%"=="3" goto scriptsbons
if "%op%"=="4" goto appsessns
if "%op%"=="0" goto sair
goto teclaerrada
...
echo.
echo.
echo 		%o%[1]%neon_vp% Limpeza Basica%w%
echo.
echo 		%o%[2]%neon_vp% Limpeza Avancada%w%
echo.
echo 		%o%[3]%neon_vp% Corrigir Windows%w%
echo.
echo 		%o%[4]%neon_vp% Limpeza de RAMs%w%
echo.
echo 		%o%[5]%neon_vp% Limpeza de Discos%w%
echo.
echo.
echo.
echo.
...
echo   %BLUE%----------------------------------------------------------------------------------------------------%RESET%
echo.
echo 		%o%[1]%neon_vp% BoosterX - Excelente%w%            %o%[15]%neon_vp% WinTools Premium- LimpezaTop%w%
echo.
echo 		%o%[2]%neon_vp% SparKle%w%                         %o%[16]%neon_vp% Glary Utilities Pro- Top%w%
echo.
echo 		%o%[3]%neon_vp% ChrisTitus Tweaks%w%               %o%[17]%neon_vp% Complete Internet Repair%w%
echo.
echo 		%o%[4]%neon_vp% Optimizer%w%                       %o%[18]%neon_vp% RevoUninstaller Pro%w%
echo.
echo 		%o%[5]%neon_vp% WinSysClean%w%                     %o%[19]%neon_vp% Revo Registry Cleaner%w%
echo.
echo 		%o%[6]%neon_vp% TweakPower%w%                      %o%[20]%neon_vp% JWizard Cleaner -Limpeza%w%
echo.
echo 		%o%[7]%neon_vp% Firemin, Edgemin e Cromin%w%       %o%[20]%neon_vp% RyTuneX - Optmizer%w%
echo.
echo 		%o%[8]%neon_vp% MemReduct %neon_vp%
echo.
echo 		%o%[9]%neon_vp% PyDebloatX%w%
echo.
echo 		%o%[10]%neon_vp% Dism++ - limpeza%w%
echo.
echo 		%o%[11]%neon_vp% Privacy-Repairer%w%
echo.
echo 		%o%[12]%neon_vp% QuickBoost%w%
echo.
echo 		%o%[13]%neon_vp% WinaeroTweaker%w%
echo.
echo 		%o%[14]%neon_vp% WinSecret-Plus%w%
echo.
echo.
...
echo.
echo.
echo      %o%[0]%neon_vp% Voltar ao Menu anterior%w%
echo.
echo.
echo %BLUE%----------------------------------------------------------------------------------------------------%RESET%
...
echo.
echo.
echo 		%o%[1]%neon_vp% Winrar-64bits (Link)%w%       %o%[13]%neon_vp% Driver Booster%w%
echo.
echo 		%o%[2]%neon_vp% Brave Browser%w%              %o%[14]%neon_vp% Recuva%w%
echo.
echo 		%o%[3]%neon_vp% Firefox Browser%w%            
echo.
echo 		%o%[4]%neon_vp% Google Chrome (Link)%w%
echo.
echo 		%o%[5]%neon_vp% KLCodec-Pack (Link)%w%
echo.
echo 		%o%[6]%neon_vp% Gimp-Me (Link)%w%
echo.
echo 		%o%[7]%neon_vp% MS-Office (Link)%w%
echo.
echo 		%o%[8]%neon_vp% WUpdate Blocker%neon_vp%
echo.
echo 		%o%[9]%neon_vp% Edge Blocker%w%
echo.
echo 		%o%[10]%neon_vp% Controle o Defender%w%
echo.
echo 		%o%[11]%neon_vp% UniGet-UI%w%
echo.
echo 		%o%[12]%neon_vp% Snapppy Driver Lite%w%
echo.
...
echo.
echo.
echo 		%o%[1]%neon_vp% WINDHAWK%w%                       %o%[3]%neon_vp% WinaAroTweaker%w%
echo.
echo 		%o%[2]%neon_vp% Open-Shell-Menu (Iniciar)%w%      %o%[4]%neon_vp% Apps Classicos%w%
echo.
echo 		%o%[5]%neon_vp% ...%w%                            %o%[6]%neon_vp% ...%w%
echo.
echo.
...
if %opcao% equ 4 goto appsclassics
  ...
  if %opcao% equ 5 goto personalizcoes
   if %opcao% equ 6 goto personalizcoes
